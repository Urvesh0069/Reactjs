...
import { removeStudent, setFilter } from "../../features/students/studentSlice";
...
const StudentList = () => {
  ...
  return (
    <div className="min-h-screen bg-[#443C68] p-6 text-gray-100 shadow-lg">
      <h2 className="text-2xl font-bold mb-6 text-center text-[#18122B]">
        Student List
      </h2>
      <div className="mb-6 flex justify-center space-x-4">
        <input
          ...
          className="mb-6 p-2  w-full max-w-xs block mx-auto  border border-[#635985] bg-[#18122B] text-white rounded"
        />
        ...
        {students && students.length > 0 ? (
          students.map((student, idx) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-[#A084DC] mb-1">
                {student.name}
              </h3>
